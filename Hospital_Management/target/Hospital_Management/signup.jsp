		...
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-4 text-center">Register new User here</p>
						
						
						<!-- USING JSTL and checking is user registration was successful by getting session objects attribute succMsg -->
